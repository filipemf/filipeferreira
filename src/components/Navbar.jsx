  ...
  return (
    <div id='navbarDefault' className='fixed w-[-webkit-fill-available] h-[80px] flex justify-between items-center px-4 bg-[#17171c] text-gray-300 ml-3 mr-3 mt-2 z-50'>
      ...
      <ul className='hidden md:flex font-bold'>
        <li>
          <Link className='navbarOption' to='home' smooth={true} duration={500}>
            {i18next.t("navbar.home")}
          </Link>
        </li>
        <li>
          <Link className='navbarOption' to='about' smooth={true} duration={500}>
            {i18next.t("navbar.about")}
          </Link>
        </li>
        <li>
          <Link className='navbarOption' to='skills' smooth={true} duration={500}>
            {i18next.t("navbar.skills")}
          </Link>
        </li>
        <li>
          <Link className='navbarOption' to='work' smooth={true} duration={500}>
            {i18next.t("navbar.portfolio")}
          </Link>
        </li>
        <li>
          <Link className='navbarOption' to='contact' smooth={true} duration={500}>
      ...
      <ul
        className={
          !nav
            ? 'hidden'
            : 'absolute top-0 left-0 w-full h-screen bg-[#22232a] flex flex-col justify-center font-bold z-[999] pl-0'
        }
      >
