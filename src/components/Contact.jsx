        ...
        <div>
          ...
          <div className='pb-[50px] pt-[50px]'>
            ...
            <div className='contactDiv'>
              ...
              <a href={localStorage.getItem('i18nextLng')==='en'?"../assets/Filipe Ferreira - Software Engineer - Resume.pdf":"../assets/Filipe Ferreira - Software Engineer - Resume.pdf"} download target="_blank" rel="noreferrer">
